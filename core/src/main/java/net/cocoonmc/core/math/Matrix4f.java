...
public class Matrix4f {
    ...
    public void multiplyFront(Quaternionf quaternion) {
...
//        }
    ...
    private static void invertGeneric(Matrix4f in, Matrix4f ret) {
        ...
        det = 1.0f / det;
        float m00 = MathHelper.fma(in.m11, l, MathHelper.fma(-in.m12, k, in.m13 * j)) * det;
        float m01 = MathHelper.fma(-in.m01, l, MathHelper.fma(in.m02, k, -in.m03 * j)) * det;
        float m02 = MathHelper.fma(in.m31, f, MathHelper.fma(-in.m32, e, in.m33 * d)) * det;
        float m03 = MathHelper.fma(-in.m21, f, MathHelper.fma(in.m22, e, -in.m23 * d)) * det;
        float m10 = MathHelper.fma(-in.m10, l, MathHelper.fma(in.m12, i, -in.m13 * h)) * det;
        float m11 = MathHelper.fma(in.m00, l, MathHelper.fma(-in.m02, i, in.m03 * h)) * det;
        float m12 = MathHelper.fma(-in.m30, f, MathHelper.fma(in.m32, c, -in.m33 * b)) * det;
        float m13 = MathHelper.fma(in.m20, f, MathHelper.fma(-in.m22, c, in.m23 * b)) * det;
        float m20 = MathHelper.fma(in.m10, k, MathHelper.fma(-in.m11, i, in.m13 * g)) * det;
        float m21 = MathHelper.fma(-in.m00, k, MathHelper.fma(in.m01, i, -in.m03 * g)) * det;
        float m22 = MathHelper.fma(in.m30, e, MathHelper.fma(-in.m31, c, in.m33 * a)) * det;
        float m23 = MathHelper.fma(-in.m20, e, MathHelper.fma(in.m21, c, -in.m23 * a)) * det;
        float m30 = MathHelper.fma(-in.m10, j, MathHelper.fma(in.m11, h, -in.m12 * g)) * det;
        float m31 = MathHelper.fma(in.m00, j, MathHelper.fma(-in.m01, h, in.m02 * g)) * det;
        float m32 = MathHelper.fma(-in.m30, d, MathHelper.fma(in.m31, b, -in.m32 * a)) * det;
        float m33 = MathHelper.fma(in.m20, d, MathHelper.fma(-in.m21, b, in.m22 * a)) * det;
        ret.m00 = m00;
        ret.m01 = m01;
        ret.m02 = m02;
        ret.m03 = m03;
