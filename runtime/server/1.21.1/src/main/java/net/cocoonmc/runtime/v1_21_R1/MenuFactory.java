...
public class MenuFactory extends TransformFactory implements IMenuFactory {
    ...
    public MenuImpl createProxy(net.cocoonmc.core.inventory.Menu impl, net.cocoonmc.core.world.entity.Player player, net.cocoonmc.core.network.Component title) {
        ...
        menu.setTitle(Component.Serializer.fromJson(title.serialize(), provider));
        return menu;
    }
    ...
    public net.cocoonmc.core.inventory.Menu getActivedMenu(net.cocoonmc.core.world.entity.Player player) {
        ...
        if (player1 != null && player1.containerMenu instanceof ProxyMenu) {
            return ((ProxyMenu) player1.containerMenu).impl;
        }
        return null;
    }
    ...
    public static class ProxyContainer implements Container {
        ...
        @Override
        public boolean canTakeItem(Container iinventory, int i, ItemStack itemstack) {
            return impl.canTakeItem(i, convertToCocoon(itemstack));
        }
